                            ...
                            <div className="card-body">
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <p>
                                        ...
                                        <input type="text" className='form-control' name='name' placeholder='Add product name' {...register('name')} />
                                    </p>
                                    <p>
                                        <label htmlFor="">Product Price:</label><br></br>
                                        <input type="number" className='form-control' name='price' placeholder='Add product price' {...register('price')} />
                                    </p>
                                    <p>
                                        <label htmlFor="">Product Quality:</label><br></br>
                                        <input type="text" className='form-control' name='quality' placeholder='Add product quality' {...register('quality')} />
                                    </p>
                                    <p>
                                        <label htmlFor="">Product Quantity:</label><br></br>
                                        <input readOnly type="text" className='form-control' name='quantity' value="1"  {...register('quantity')} />
                                    </p>
                                    <p>
                                        <label htmlFor="">Selece Role:</label><br></br>
                                        <select className='form-control' name='select' {...register('select')}>
